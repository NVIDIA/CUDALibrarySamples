...
int main(int argc, char *argv[]) {
    ...
    i                   = 0;
    csr_values_h[i++].x = 4.0;
    csr_values_h[i++].x = 1.0;
    csr_values_h[i++].x = 3.0;
    csr_values_h[i++].x = 2.0;
    csr_values_h[i++].x = 5.0;
    csr_values_h[i++].x = 1.0;
    csr_values_h[i++].x = 1.0;
    csr_values_h[i++].x = 2.0;
    ...
    CUDSS_CALL_AND_CHECK(cudssMatrixCreateDn(&b, nrows, nrhs, ldb, b_values_d,
                                             CUDSS_C_32F, CUDSS_LAYOUT_COL_MAJOR),
    ...
    CUDSS_CALL_AND_CHECK(cudssMatrixCreateCsr(&A, nrows, ncols, nnz, csr_offsets_d, NULL,
                                              ...
                                              CUDSS_R_32I, CUDSS_C_32F, mtype, mview,
                                              base),
