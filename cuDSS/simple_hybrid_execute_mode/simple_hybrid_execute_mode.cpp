...
int main(int argc, char *argv[]) {
    ...
    CUDSS_CALL_AND_CHECK(cudssMatrixCreateDn(&b, nrows, nrhs, ldb, b_values_h,
                                             CUDSS_R_64F, CUDSS_LAYOUT_COL_MAJOR),
                         status, "cudssMatrixCreateDn for b");
    CUDSS_CALL_AND_CHECK(cudssMatrixCreateDn(&x, ncols, nrhs, ldx, x_values_h,
                                             CUDSS_R_64F, CUDSS_LAYOUT_COL_MAJOR),
