...
int main(int argc, char *argv[]) {
    ...
    printf(
        "Second solution (solved separately by specifying CUDSS_CONFIG_UBATCH_INDEX)\n");
    for (int i = 0; i < n; i++) {
