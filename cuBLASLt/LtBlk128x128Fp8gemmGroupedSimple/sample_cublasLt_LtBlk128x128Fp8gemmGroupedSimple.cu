...
///
/// Sample wrapper executing grouped FP8 gemm with block scaling (VEC128/BLK128x128).
...
void LtBlk128x128Fp8gemmGroupedSimple(cublasLtHandle_t ltHandle,
    ...
    // set block scaling mode (VEC128 for A, BLK128x128 for B)
