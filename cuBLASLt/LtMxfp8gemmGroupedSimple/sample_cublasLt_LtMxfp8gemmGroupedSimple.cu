...
///
/// Sample wrapper executing grouped MXFP8 gemm with cublasLtMatmul, using VEC32_UE8M0 block scaling.
...
void LtMxfp8gemmGroupedSimple(cublasLtHandle_t ltHandle,
                              ...
                              int64_t avgK,
                              const float *alpha,
                              const __nv_fp8_e8m0 *const *a_scale,
                              const __nv_fp8_e4m3 *const *A,
                              const void *ldaArrayDev,
                              const __nv_fp8_e8m0 *const *b_scale,
    ...
    // set block scaling mode (VEC32_UE8M0 for MXFP8)
