...
/*
 * This example shows how to evaluate the exchange correlation potential.
 ...
 * for those matrices. In real applications of cuEST, these matrices should
 * be obtained during an SCF procedure.
 *
...
int main(int argc, char **argv)
{
    ...
    cuestXCPotentialRKSComputeParameters_t rks_potential_parameters;
    checkCuestErrors(cuestParametersCreate(
        CUEST_XCPOTENTIALRKSCOMPUTE_PARAMETERS, 
        &rks_potential_parameters));
    ...
    cuestXCPotentialUKSComputeParameters_t uks_potential_parameters;
    checkCuestErrors(cuestParametersCreate(
        CUEST_XCPOTENTIALUKSCOMPUTE_PARAMETERS, 
        &uks_potential_parameters));
