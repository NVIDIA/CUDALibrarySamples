...
def test_uhf():
    ...
    reference_values = {
        "hf": {
            'sto-3g'    : -1.7370573959454141E+03,
            'def2-svp'  : -1.7583722969975129E+03,
            'def2-tzvp' : -1.7603703411987769E+03,
            # def2-QZVP really wants an 80 GB A100 - disabling by default
            # 'def2-qzvp' : -1.7604590708291159E+03,
        },

        "b3lyp1": {
            'sto-3g'    : -1.7467223423790854E+03,
            'def2-svp'  : -1.7686934128079647E+03,
            'def2-tzvp' : -1.7707062466194450E+03,
        },
    }
