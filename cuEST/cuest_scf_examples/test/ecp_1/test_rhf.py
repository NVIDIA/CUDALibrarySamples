...
def test_rhf_ecp():
    ...
    reference_values = {
        'def2-tzvp' : (
            -6.3224566719977099E+02,
            np.array(
               [[ 0.000000000002, -0.000000000000, -0.222918542143],
                [-0.196637816962, -0.000000000001,  0.107583174622],
                [ 0.196637816961,  0.000000000001,  0.107583174619],
                [ 0.000000000000,  0.030845791021,  0.003876096451],
                [-0.000000000000, -0.030845791021,  0.003876096451]]),
        ),
    }
