...
# separate handles for every UHF instance
...
# UHF describes open-shell systems. Here we treat the radical anion: a net
# charge of -1 with one unpaired electron (spin multiplicity 2S+1 = 2).
charge = -1
multiplicity = 2
...
print('SCF Energy: %24.16E' % (uhf.compute_energy()))
print('')

#properties = uhf.compute_properties()

#print('SCF Gradient:')
#print(uhf.compute_gradient().to_numpy())
