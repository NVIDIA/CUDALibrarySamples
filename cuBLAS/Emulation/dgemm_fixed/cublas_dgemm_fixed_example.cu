...
/*
 * This sample demonstrates emulated DGEMM in fixed mantissa control.  Fixed mantissa control allows users to specify how many mantissa bits will be
...
int main(int argc, char *argv[]) {
    ...
    // Disables the automatic precision tuning algorithm
