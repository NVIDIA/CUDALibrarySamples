...
/*
 * This sample demonstrates emulated ZGEMM in fixed mode.  Fixed mode allows users to specify how many mantissa bits will be
...
int main(int argc, char *argv[]) {
     ...
     */
    workspaceSizeInBytes = getFixedPointWorkspaceSizeInBytes(m, n, k, 1, true, mControl, mantissaBitCount);
