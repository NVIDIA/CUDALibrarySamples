# cuBLAS Extension APIs - `cublasGemmStridedBatchedEx`
...
## CUDA APIs involved
- [cublasGemmStridedBatchedEx API](https://docs.nvidia.com/cuda/cublas/index.html#cublas-GemmStridedBatchedEx)
