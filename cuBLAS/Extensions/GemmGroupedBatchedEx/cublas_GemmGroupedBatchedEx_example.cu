...
int main(int argc, char *argv[]) {
    ...
    CUBLAS_CHECK(cublasGemmGroupedBatchedEx(
        ...
        alpha_array, (void **)d_A_array, traits<data_type>::cuda_data_type,
        lda_array, (void **)d_B_array, traits<data_type>::cuda_data_type,
        ldb_array, beta_array, (void **)d_C_array,
        traits<data_type>::cuda_data_type, ldc_array, group_count, group_size,
        compute_type));
