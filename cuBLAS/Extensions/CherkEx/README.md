# cuBLAS Extension APIs - `cublasCherkEx`

## Description

This code demonstrates a usage of cuBLAS `CherkEx` function to perform a Hermitian rank-k update
...
## CUDA APIs involved
- [cublasCherkEx API](https://docs.nvidia.com/cuda/cublas/index.html#cublas-cherkEx)
