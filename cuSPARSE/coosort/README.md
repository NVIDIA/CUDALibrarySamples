# cuSPARSE APIs - `cusparseXcoosort`

## Description

This sample demonstrates the usage of `cusparseXcoosortByRow` to perform sorting of COO format.

[cusparseXcoosort Documentation](https://docs.nvidia.com/cuda/cusparse/index.html#coosort)

## Building

* Command line
    ```bash
    nvcc -I<cuda_toolkit_path>/include coosort_example.c -o coosort_example -lcusparse
    ```
