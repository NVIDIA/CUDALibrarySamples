...
int main(int argc, char* argv[])
{
...

    {
        ...
        const int64_t lldb       = cusolverMpNUMROC(ldb, mbB, rank % numRowDevices, rsrcb, numRowDevices);
        const int64_t localColsB = cusolverMpNUMROC(colsB, nbB, rank / numRowDevices, csrcb, numColDevices);
