...
//        bUse115 = 1;
    ...
    if (loadRaw8BitImage(pInputImageHost, oSizeROI.width * sizeof(Npp8u), oSizeROI.height, 0) == 0)
    {
        ...
        nppStatus = nppPlusV::nppiLabelMarkersUF_8u32u_C1R_Ctx(pInputImageDev,
        ...
        nppStatus = nppPlusV::nppiCompressMarkerLabelsUF_32u_C1IR_Ctx(pUFLabelDev, oSizeROI.width * sizeof(Npp32u), oSizeROI, 
        ...
        nppStatus = nppPlusV::nppiCompressedMarkerLabelsUFInfo_32u_C1R_Ctx(pUFLabelDev, 
                                                                 oSizeROI.width * sizeof(Npp32u), 
                                                                 oSizeROI,
                                                                 nCompressedLabelCount, 
 ...
 */
  ...
  nppStatus = nppPlusV::nppiCompressedMarkerLabelsUFContoursGenerateGeometryLists_C1R_Ctx(pMarkerLabelsInfoListDev,
