...
#include <type_traits>
#include "common.hpp"
#include "reference/cublas_reference.hpp"
#include "reference/naive_reference.hpp"
...
namespace example {
    ...
    reference_gemm(Alpha                                       alpha,
        ...
        static constexpr bool additional_conj_a = (not use_cublas) and cublasdx::transpose_mode_of_a<BLAS> == cublasdx::transpose_mode::conj_transposed;
        static constexpr bool additional_conj_b = (not use_cublas) and cublasdx::transpose_mode_of_b<BLAS> == cublasdx::transpose_mode::conj_transposed;
        ...
        if constexpr(use_cublas) {
            ...
            reference_gemm_naive_device(m, n, k,
                                        convert<compute_value_type>(alpha),
                                        ref_data_a,
                                        lda,
