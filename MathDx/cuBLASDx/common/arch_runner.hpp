...
namespace example {
    ...
    StatusType arch_runner(unsigned cuda_device_arch, Functor example_functor, Args&&... args) {
        ...
        switch (cuda_device_arch) {
            ...
            case 1200: {
                if constexpr (EnableSM::sm_120a) {
                    return example_functor(
                        std::integral_constant<int, 1200> {}, arch_specific_modifier, static_cast<Args&&>(args)...);
                } else if constexpr (EnableSM::sm_120) {
                    return example_functor(
            ...
            case 1210: {
                if constexpr (EnableSM::sm_121a) {
                    return example_functor(
                        std::integral_constant<int, 1210> {}, arch_specific_modifier, static_cast<Args&&>(args)...);
                } else if constexpr (EnableSM::sm_121) {
                    return example_functor(
