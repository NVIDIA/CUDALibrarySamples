...
int run_matmul_ag(const Options& opts)
{
    ...
    generate_random_matrix(
        ...
        tb ? rank : 0,
        tb ? 0 : rank);
    generate_random_matrix(m, n, h_D.data(), loc_d_m, loc_d_n, 1, 1, loc_d_m, nranks, 1, rank, 0);
